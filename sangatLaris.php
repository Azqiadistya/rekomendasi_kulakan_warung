...
<html lang="en">
  ...
  <body>
    ...
    <div class="container content">
        <h3>Produk Sangat Laris</h3>
        <a type="button" class="btn btn-warning" href="rekomendasi.php">All</a>
    ...
    <table class="table">
		...
		<?php
			include "koneksi.php";
			$SQL = mysqli_query($konek, "SELECT * FROM rekomendasi WHERE status LIKE 'Sangat Laris%' ");
